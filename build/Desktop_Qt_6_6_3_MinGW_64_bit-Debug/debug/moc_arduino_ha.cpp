/****************************************************************************
** Meta object code from reading C++ file 'arduino_ha.h'
**
...
#error "The header file 'arduino_ha.h' doesn't include <QObject>."
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSArduinoENDCLASS_t qt_meta_stringdata_CLASSArduinoENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(8, 12),  // "dataReceived"
        QT_MOC_LITERAL(21, 0),  // ""
        QT_MOC_LITERAL(22, 4),  // "data"
        QT_MOC_LITERAL(27, 15)   // "handleReadyRead"
    },
    "Arduino",
    "dataReceived",
    "",
...
void Arduino::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &Arduino::dataReceived; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Arduino::dataReceived(const QString & _t1)
{
