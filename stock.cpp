...
stock::stock(int code_stock, int quantity_stock, QString nom_stock, QString type_stock, QDate date_stock, double temperature)
{
    ...
    this->temperature = temperature;  // Assign temperature
}
...
double stock::getTemperature() const { return temperature; }
...
void stock::setTemperature(double temperature) { this->temperature = temperature; }
...
bool stock::ajouter()
{
    ...
    QSqlQuery query;
    query.prepare("INSERT INTO MEDICAMENTS (CODE, NOM, TYPE, QUANTITE, DATE_EXPIRATION, TEMPERATURE) "
    ...
    query.bindValue(":DATE_EXPIRATION", date_stock);
...
bool stock::modifier()
{
    ...
    QSqlQuery query;
    query.prepare("UPDATE MEDICAMENTS SET NOM = :NOM, TYPE = :TYPE, QUANTITE = :QUANTITE, DATE_EXPIRATION = :DATE_EXPIRATION, TEMPERATURE = :TEMPERATURE "
                  "WHERE CODE = :CODE");

    // Store the old values before updating
    int quantiteOld = quantity_stock;
    QDate dateExpirationOld = date_stock;  // Assuming you want to track expiration as part of the stock change
    double temperatureOld = temperature;
